...
function initApiKey() {
  ...
  // Keep modal hidden on initial load - show landing page first
...
function getSystemPrompt() {
  if (currentLanguage === 'lg') {
    return `Oli LexUg — omukozi w'amateeka g'obuwangwa bwa Uganda. Ddamu ebibuuzo mu Luganda, mu ngeli enyangu n'ey'okutegeera.

EMPISA Z'OKUDDAMU:
1. Ddamu mu Luganda omulembe — okwamba ennyumba eri bantu abasimu n'abanakuwamba
...
const DEMO_RESPONSES = {
  default: `Great question! Uganda has a rich legal framework rooted in the **Constitution of Uganda 1995**, which is the supreme law of the land.
...
• An independent body that organizes all elections (**Article 60**)
• Registers voters, qualifies candidates, and declares results

**Your Voting Rights (Article 59):**
• Every Ugandan citizen aged **18 and above** has the right to vote
• You must be registered — register at the Electoral Commission offices in your area

---
⚠️ **Important:** LexUg provides civic education, not legal advice. For your specific situation, please consult a qualified Ugandan lawyer.`,

  worker: `Uganda's employment laws protect workers across the country.

**Your Rights as a Worker (Employment Act 2006):**

**Working Hours & Pay:**
• Maximum **48 hours per week** (8 hours/day, 6 days)
• **Overtime** must be paid at a higher rate if you work beyond contracted hours
• You must receive a written **pay slip** detailing your earnings and deductions

**Leave Entitlements:**
• **Annual leave:** Minimum 21 working days per year (after 12 months of service)
• **Maternity leave:** 60 working days (fully paid) — **Section 58 of the Employment Act**
• **Paternity leave:** 4 working days
• **Sick leave:** Up to 30 days with full pay, 15 days with half pay per year

**Protection from Unfair Dismissal:**
• Your employer must give you **notice** before terminating your employment
• You are entitled to **severance pay** after 5 years of service
• Discriminatory dismissal (based on gender, religion, pregnancy, etc.) is illegal

**Trade Unions:**
• You have the right to **form or join a trade union** (**Article 40 of the Constitution**)

**Where to Complain:** The **Ministry of Gender, Labour and Social Development** handles labour disputes.
